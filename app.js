...
// Handle print functionality enhancement
window.addEventListener('beforeprint', function() {
    ...
    Promise.all(promises).then(() => {
        // Additional print preparation can be done here
    });
});
